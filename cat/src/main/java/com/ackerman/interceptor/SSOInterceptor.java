        ...
        try {
            ...
            if(cookies != null){
                for(Cookie cookie : cookies){
                    ...
                    if(name.equals(Common.LOCAL_TICKET_CAT))
            ...
            if(local != null && ssoService.verifyTicketOrUpdate(Common.LOCAL_TICKET_CAT, local)) {
                UserModel user = ssoService.getUserByTicket(Common.LOCAL_TICKET_CAT, local);
            ...
            if(global != null && ssoService.verifyTicketOrUpdate(Common.GLOBAL_TICKET, global)){
                ...
                local = ssoService.createLocalSession(request, response, Common.LOCAL_TICKET_CAT, user);
                ssoService.addTicketSet(global, Common.LOCAL_TICKET_CAT, local);
                return true;
            }
